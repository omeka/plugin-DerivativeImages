...
<section class="seven columns alpha">
    ...
    This plugin is useful if image sizes must change for a new theme, after upgrading 
    from an earlier version of Omeka, or after your server's 
    <a href="http://www.imagemagick.org/script/index.php">ImageMagick</a> software has 
    been upgraded.</p>
    <p>Please note that Omeka is unable to create derivative images for some files. 
    We highly recommend that you back up Omeka's files directory before running this 
    process.</p>
    <div class="field">
        ...
        <div class="inputs five columns omega">
            <p class="explanation">Select files for creating new derivative images.</p>
    ...
    <div class="field">
        ...
        <div class="inputs five columns omega">
            ...
            none will create all image sizes. (Sizes listed here are set in the 
            <a href="<?php echo url('appearance/edit-settings'); ?>">Appearance settings</a>.)</p>
    ...
    <div class="field">
        ...
        <div class="inputs five columns omega">
            ...
            Checking none will process all MIME types. (This list represents every 
            MIME type currently available in this Omeka site.)</p>
